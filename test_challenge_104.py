...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "twt_104.py"
    ...
    OTHER_LANG_COMMAND = "python3 twt_104.py"
    ...
    TEST_CASE_FILE = "test_cases.json.gz"  #  1k test cases max number of demons 3_000
    TEST_CASE_FILE = "test_cases_b.json.gz"    # 500 test cases max number of demons 50_000
...
def print_extra_stats(
    ...
    print(f" - max number of demons: {yellow}" f"{max(int(x[0]) for x in test_inp):_}{reset}")
    print(
        f" - Average number of demons: {yellow}"
